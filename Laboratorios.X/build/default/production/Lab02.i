...
;---------------loop principal---------------
 ...
 loop:
    btfsc PORTB, 0 ;Prueba del bit ((PORTB) and 07Fh), 0
    call inc_cont1 ;Si se presiona el boton en ((PORTB) and 07Fh), 0 se llama la Subrutina
    btfsc PORTB, 1 ;Prueba del bit ((PORTB) and 07Fh), 1
    call dec_cont1 ;Si se presiona el boton en ((PORTB) and 07Fh), 1 se llama la Subrutina

    btfsc PORTB, 2 ;Prueba del bit ((PORTB) and 07Fh), 2
    call inc_cont2 ;Si se presiona el boton en ((PORTB) and 07Fh), 2 se llama la Subrutina
    btfsc PORTB, 3 ;Prueba del bit ((PORTB) and 07Fh), 3
    call dec_cont2 ;Si se presiona el boton en ((PORTB) and 07Fh), 3 se llama la Subrutina

    btfsc PORTB, 4 ;Prueba del bit ((PORTB) and 07Fh), 4
    call sum ;Si se presiona el boton en ((PORTB) and 07Fh), 4 se llama la Subrutina
