...
intB:
    ...
    btfss PORTB, 0 ;Verificar si el boton en ((PORTB) and 07Fh), 0 se esta presionando
    incf PORTA ;Si se presiona incrementar el PORTA

    btfss PORTB, 1 ;Verificar si el boton en ((PORTB) and 07Fh), 1 se esta presionando
...
config_IO:
    ...
    bsf WPUB, 0 ;Habilitar el pullup interno en ((PORTB) and 07Fh), 0
    bsf WPUB, 1 ;Habilitar el pullup interno en ((PORTB) and 07Fh), 1
